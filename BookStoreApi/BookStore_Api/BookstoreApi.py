...
class AccountApi:
    ...
    def authorized_account(self, data:json) -> tuple[int,str]:
    ...
    def post_account(self, data:json)-> tuple[int,str]:
    ...
    def get_user_by_id(self, userId:str)-> tuple[int,str]:
...
class BookStoreApi:
    ...
    def get_book(self, isbn)-> tuple[int,str]:
    ...
    def put_books(self, data, isbn)-> tuple[int,str]:
